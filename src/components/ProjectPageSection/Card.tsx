    ...
    >
      ...
      <div className="flex flex-col justify-between gap-3 flex-grow">
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm md:text-base lg:text-lg line-clamp-1 font-normal">
          ...
          <p className="text-gray-400 text-sm md:text-base lg:text-lg line-clamp-3">
            {description}
          </p>
        </div>
          ...
          <div className="flex flex-wrap gap-2 mt-3">
            {tags && isSeeAll
              ? tags.map((tag) => (
                  <Tag
                    key={tag}
                    text={tag}
                    className="bg-gray-200 text-xs md:text-sm lg:text-base xl:text-lg"
                  />
                ))
              : tags
                  ?.slice(0, 3)
            ...
            {tags && tags?.length > 3 && (
              <button
                ...
                className="text-blue-500 text-xs md:text-sm lg:text-base xl:text-lg"
              >
